-- CREATE COMPLETED_CHALLENGES TABLE AND RELATED FUNCTIONALITY
-- This script sets up the complete challenge completion tracking system

-- 1. Create the completed_challenges table
...
-- INSERT INTO public.completed_challenges (user_id, challenge_id, challenge_title, challenge_description, xp_earned)
-- VALUES 
--     ('your-user-id-here', 'challenge-1', 'Sample Challenge 1', 'This is a sample challenge', 10),
--     ('your-user-id-here', 'challenge-2', 'Sample Challenge 2', 'This is another sample challenge', 15);

-- 12. Verification query
SELECT 'Completed challenges table and functionality created successfully!' as result; 