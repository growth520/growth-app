-- Fixed Pack Completion Function
-- This version properly handles the GROUP BY clause and avoids jsonb_agg errors
...
BEGIN
    ...
    IF challenges_array = '[]'::jsonb OR challenges_array IS NULL THEN
        challenges_array := '[]'::jsonb;
