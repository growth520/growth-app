-- =====================================================
-- FIX MISSING TABLES AND RELATIONSHIPS (FINAL CORRECTED)
-- =====================================================
-- This script creates all missing tables that the app code references
-- Based on the actual database schema and handles type mismatches
...
-- Insert a sample user pack progress for the current user (with proper type casting)
...
VALUES (
    ...
    (SELECT id FROM public.challenge_packs WHERE title = 'Mindfulness Starter Pack' LIMIT 1)::BIGINT,
    NOW(),
    false,
    0,
    1
