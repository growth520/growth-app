-- Drop and recreate the complete_individual_challenge function with proper column qualification
DROP FUNCTION IF EXISTS complete_individual_challenge(uuid,bigint,text);

-- Create the complete_individual_challenge function with fixed column references
