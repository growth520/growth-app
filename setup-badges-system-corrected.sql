-- Setup Badge System (Corrected)
-- This script creates the badges and user_badges tables with proper error handling

-- First, drop existing tables if they exist (to ensure clean structure)
...
-- Verify the setup
SELECT 'Badges table created with ' || COUNT(*) || ' badges' as result FROM badges;
SELECT 'User badges table created successfully' as result; 